...
public:
	...
	void mongo_GetAuthInfo(std::shared_ptr<CMongoManager::MongoRetDatas>  &retDatas, std::string &errMsg, AccepterID aID, SessionID sID, SessionInfo info, const ProtoAuthReq & req);
private:
};
