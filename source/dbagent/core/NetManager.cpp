...
bool CNetManager::Start()
{
	...
	m_configListen.listenIP = GlobalFacade::getRef().getServerConfig().getConfigListen(DBAgentNode).ip;
	m_configListen.listenPort = GlobalFacade::getRef().getServerConfig().getConfigListen(DBAgentNode).port;
